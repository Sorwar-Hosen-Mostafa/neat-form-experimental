...
import com.nerdstone.neatform.custom.builders.CustomSpinnerViewBuilder
...
class CustomSpinnerView(context: Context) : androidx.appcompat.widget.AppCompatSpinner(context), NFormView {
    ...
    override val viewBuilder = CustomSpinnerViewBuilder(this)
