...
open class TextInputEditTextBuilder(open override val nFormView: NFormView) : ViewBuilder {

    protected val textInputEditTextNFormView = nFormView as TextInputEditTextNFormView
    ...
    protected fun formatHintForRequiredFields() {
